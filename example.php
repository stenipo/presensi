...
; // Ganti dengan path ke file font di sistem Anda
    ...
    imagettftext($newImage, 20, 0, 10, $yOffset + 30, $black, $fontPath, "Alamat: " . $jemaatData['alamat']);
    imagettftext($newImage, 20, 0, 10, $yOffset + 60, $black, $fontPath, "Tanggal Lahir: " . $jemaatData['tanggal_lahir']);
    imagettftext($newImage, 20, 0, 10, $yOffset + 90, $black, $fontPath, "Sektor: " . $jemaatData['sektor']);
    imagettftext($newImage, 20, 0, 10, $yOffset + 120, $black, $fontPath, "Nomor Telepon: " . $jemaatData['nomor_telepon']);
